...
export function ProductsHero() {
  ...
  return (
    <section className="relative w-full overflow-hidden bg-[#10271D] text-[#F4F1E8] pt-32 pb-16 md:pt-40 md:pb-24 border-b border-white/10">
      {/* Background Machinery Blueprint & Gradients */}
      <motion.div
      ...
      >
        <Image
          ...
          alt="Agricultural Machinery Catalogue"
          fill
          priority
          sizes="100vw"
      ...
      <Container size="default" className="relative z-20">
        <div className="max-w-3xl">
          ...
          <FadeUp>
            <div className="flex items-center gap-3 mb-6">
              ...
              <span className="text-[11px] font-mono tracking-widest text-[#D8D9D3]/70 uppercase">
                10 VERIFIED IMPLEMENTS
              </span>
            </div>
          </FadeUp>

          {/* Space Grotesk Main Headline */}
          ...
          {/* Description */}
          <FadeUp delay={0.2}>
            <p className="text-body-lg text-[#D8D9D3] max-w-2xl leading-relaxed mb-8">
              Explore tractor-mounted implements, primary tillage ploughs, rotary tillers, and custom
              agricultural equipment built for demanding soil conditions and maximum operational durability.
            </p>
          </FadeUp>
