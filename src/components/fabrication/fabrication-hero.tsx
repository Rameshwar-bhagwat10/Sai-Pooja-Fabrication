...
export function FabricationHero() {
  ...
  return (
    <section className="relative w-full overflow-hidden bg-[#10271D] text-[#F4F1E8] pt-32 pb-16 md:pt-40 md:pb-24 border-b border-white/10">
      {/* Background Workshop Image & Gradients */}
      <motion.div
      ...
      >
        <Image
          ...
          alt="Heavy Industrial Fabrication Workshop"
          fill
          priority
          sizes="100vw"
        ...
        <div className="max-w-3xl">
          ...
          <FadeUp delay={0.2}>
            <p className="text-body-lg text-[#D8D9D3] max-w-2xl leading-relaxed mb-8 font-sans">
              Precision hydraulic forming, multi-pass MIG structural welding, and custom agricultural
              implement manufacturing engineered for severe drawbar pull and heavy soil resistance.
            </p>
          </FadeUp>

          {/* Technical Process Badges */}
          <FadeUp delay={0.3}>
            <div className="flex flex-wrap gap-2 pt-2">
              <span className="px-3 py-1.5 rounded-[6px] bg-white/5 border border-white/10 text-xs font-mono text-[#C8913D]">
                RIGID FIXTURE ALIGNMENT
              </span>
