    ...
    <section className="relative w-full overflow-hidden bg-[#10271D] text-[#F4F1E8] pt-32 pb-16 md:pt-40 md:pb-24 border-b border-white/10">
      ...
      >
        <Image
          ...
          alt="Sai Pooja Fabrication Workshop Office"
          fill
          priority
          sizes="100vw"
        ...
        <div className="max-w-3xl">
          ...
          <FadeUp>
            <div className="flex items-center gap-3 mb-6">
              ...
              <span className="text-[11px] font-mono tracking-widest text-[#D8D9D3]/70 uppercase">
                AGRICULTURAL MACHINERY CONSULTATION
              </span>
            </div>
          </FadeUp>
          ...
          <TextReveal delay={0.1}>
            <h1 className="text-display font-display tracking-tight text-[#F4F1E8] mb-6">
              LET&apos;S TALK EQUIPMENT. HAVE A REQUIREMENT?
            </h1>
          </TextReveal>
          ...
          <FadeUp delay={0.2}>
            <p className="text-body-lg text-[#D8D9D3] max-w-2xl leading-relaxed mb-8 font-sans">
              Talk directly with our fabrication engineers regarding agricultural implement pricing,
              tractor horsepower matching, custom hitch fabrication, or workshop visits.
            </p>
          </FadeUp>

          {/* Response Channels Badges */}
          <FadeUp delay={0.3}>
